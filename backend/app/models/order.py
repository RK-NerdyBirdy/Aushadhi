from sqlalchemy import Column, Integer, VARCHAR, Numeric, DATE, TIMESTAMP, ForeignKey, CheckConstraint, func
...
class Order(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint('received_quantity >= 0', name='ck_received_quantity_positive'),
    )
